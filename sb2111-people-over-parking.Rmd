...
all_calendar_dates <- rbindlist(list(cta_data$calendar_dates, pace_data$calendar_dates, metra_data$calendar_dates, metro_stl_data$calendar_dates, cumtd_data$calendar_dates), fill = TRUE, use.names = TRUE)
